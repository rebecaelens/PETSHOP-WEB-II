(() => {
  ...
  const normalizeImageUrl = (value) => {
    ...
    if (!src) return '../carrinho/images/cards.jpg';
    ...
    return `
      <article class="product-card" data-product data-category="${escapeHtml(product.category || '')}" data-promocao="${hasPromo ? 'true' : 'false'}" data-price-per-kg="${pricePerKg || ''}" id="${escapeHtml(product.id)}">
        ...
        <div class="product-body">
          <button class="fav-btn" type="button" data-favorito aria-label="Favoritar"><img src="../carrinho/images/favorite.png" alt="Favoritar"></button>
          ${hasPromo ? '<img src="../carrinho/images/venda.png" alt="Promoção" class="sale-badge">' : ''}
